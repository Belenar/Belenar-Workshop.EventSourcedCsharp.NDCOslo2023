...
public record Add_shipping_label(Guid AggregateId, string Carrier, string Tracking_code) : Command;

public record Add_beer_to_box(Guid AggregateId, string Beer_name) : Command;
